...
\item[]
  ...
  \begin{itemize}
    ...
    \resitem{Notable Courses: Computer Vision (CS 670), Internet Law and Policy (CS 690L), Machine Learning (CS 689)}
	\end{itemize}
...
\begin{itemize}
  \item \textbf{Languages:} Bro/Zeek, C++, HTML/CSS, Java, JavaScript, LaTeX, Lua, PHP, Python, R, SQL
