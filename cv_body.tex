...
Networks, network measurement, network security, censorship and censorship circumvention, and digital privacy. Secondary interest in financial market modeling.
...
\item[]
  ...
  \begin{itemize}
    ...
    \resitem{Notable Courses: Affective Computing (CS 527), Neural Networks (CS 682), Penetration Testing (CS 590A)}
	\end{itemize}
