...
\item[]
  ...
  \begin{itemize}
    ...
    \resitem{Notable Courses: Research Methods for Empirical Computer Science (CS 691DD), Internet Law and Policy (CS 690L), Advanced Networks (CS 683), Advanced Natural Language Processing (CS 685)}
	\end{itemize}
