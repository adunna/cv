...
\pagestyle{fancy}
\fancyhf{}
\lfoot{\makebox[\textwidth][l]{Arun Dunna - CV}}
...
\newcommand{\resitemtwo}[2]{\item #1 \vspace{-2pt} \null\hfill #2}
\newcommand{\resitemthree}[3]{\item[--] \textbf{#1}, \textit{#2} \vspace{-2pt} \null\hfill #3}
\newcommand{\resitemfour}[3]{\item \textbf{#1}, \textit{#2} \vspace{-2pt} \null\hfill #3}
...
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
    ...
    \textit{#2} & \\
\end{tabular*}\vspace{-6pt}}
\newcommand{\ressubheadingNONITthree}[3]{
\begin{tabular*}{6.5in}{l@{\cftdotfill{\cftsecdotsep}\extracolsep{\fill}}r}
		\textbf{#1}, #2 & \textit{#3} \\
\end{tabular*}}
%-----------------------------------------------------------
